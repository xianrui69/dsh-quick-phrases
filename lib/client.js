window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/** The floating ⚙ popover: outside-click + Escape close around PhraseEditor. */
		...
		/**
		 * DSH 设置页常驻 section（v0.4.0，settings.section slot）：快捷条隐藏、
		 * 塌缩齿轮也不在时，设置页永远能管理短语（用户实测需求，机制同
		 * Token 面板）。与 ⚙ 弹层共用 PhraseEditor，编辑同一份 store。
		 */
		function QuickPhrasesSettingsSection() {
			return react_jsx_runtime.jsxs("div", { className: "qp-settings-section", children: [
				react_jsx_runtime.jsx("div", { className: "qp-settings-note", children: "短语挂在输入框上方的快捷条与 / 菜单；此处与输入框旁的「⚙ 管理」编辑同一份数据，改动即时保存。" }),
				react_jsx_runtime.jsx(PhraseEditor, {})
			] });
		}
		/**
